...
from tensorflow.keras.layers import Dense, Dropout, GRU     # Dense: fully connected layers; Dropout: regularization; GRU: gated recurrent unit
...
# build GRU model
model = Sequential([
    GRU(128, return_sequences=True, input_shape=(30, 63)), # 128 units, 30 sequence frames,63 inputs/keypoints
